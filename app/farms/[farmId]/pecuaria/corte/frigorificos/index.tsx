          ...
          <FadeSlideIn delay={40}>
            <View style={styles.section}>
              ...
              {isLoadingRanking ? (
                ...
                ranking.map((entry, index) => <RankingRow key={entry.slaughterhouseId} entry={entry} rank={index + 1} styles={styles} />)
              )}
            </View>
          </FadeSlideIn>
        )}
...
function RankingRow({ entry, rank, styles }: { entry: SlaughterhouseRanking; rank: number; styles: ReturnType<typeof createStyles> }) {
  return (
